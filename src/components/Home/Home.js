...
function App() {
  ...
  specePgm = spaceXdata.map((item, i) => {
    return (
      <div className="col-s-4 col-2 spacexDiv">
        <img
          className="imgBg"
        ...
        />
        <p>
          <a href="#">{`${item.mission_name} #${i + 1}`} </a>
        </p>
        <div>
          ...
          {item.mission_id.length ? (
            <ul>
              {" "}
              {item.mission_id.map((val) => (
                <li className="value" key={val}>
                  {val}
                </li>
              ))}{" "}
            </ul>
        ...
        <p>
          <strong>Launh Year</strong>:{" "}
          <span className="value">{item.launch_year}</span>{" "}
        </p>
        <p>
          <strong>Successful Launch</strong>:{" "}
          <span className="value">{item.launch_success ? "Yes" : "No"}</span>
        </p>
        <p>
          <strong>Successful Landing</strong>:{" "}
          <span className="value">{item.land_success ? "Yes" : "No"}</span>
        </p>
      </div>
    );
  });
    ...
    <div className="component-home container">
      ...
      <div class="row">
        ...
        <div className="col-s-8 col-10">
          <main class="component-home--content content">{specePgm}</main>
        </div>
      </div>

      <div className="row footer">
        <p>
          Developed by <strong>Jaysu</strong>
        </p>
      </div>
    </div>
  );
